  ...
  },
  {
    ...
    rules: {
      "no-restricted-syntax": [
        ...
        {
          selector:
            "CallExpression[callee.property.name='from'][arguments.0.value=/^(products|product_variants|product_bom_items|packaging_materials|business_settings|orders|order_items|categories|customization_options|import_runs|profiles|back_in_stock_requests|inventory_movements)$/]",
          message:
  ...
  },
  {
    ...
    rules: {
      "no-restricted-syntax": [
        ...
        {
          selector:
            "CallExpression[callee.property.name='from'][arguments.0.value=/^(business_settings|brands|brand_return_policies|brand_notification_recipients|profiles|products)$/]",
          message:
            "Settings go through `@/lib/data/business-settings` and `@/lib/data/brands` (queries and mutations), not direct Supabase calls.",
        },
        {
          selector:
            "ArrayExpression > Literal:first-child[value=/^(business-settings.*|brands?|store-profile|readiness-(business-settings|brand-details)|brand-notification-recipients|readiness-active-products)$/]",
          message:
  ...
  },
  {
    ...
    rules: {
      "no-restricted-syntax": [
        ...
        {
          selector:
            "ArrayExpression > Literal:first-child[value=/^(business-settings.*|business-name|content-studio-settings|review-story-(brand|order)|discounts-analytics|promo-codes|discounts-product-variants|brand-order-reviews|return-activity-logs|content-studio-products)$/]",
  ...
  },
  {
    ...
    rules: {
      "no-restricted-syntax": [
        ...
        {
          selector:
            "ArrayExpression > Literal:first-child[value=/^(brand-return-policy|readiness-return-policy|storefront-return-policy|brand_branches_active)$/]",
