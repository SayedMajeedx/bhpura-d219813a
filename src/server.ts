...
const SECURITY_HEADERS = {
  "Content-Security-Policy":
    "default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'self' https://*.boutq.store https://boutq.store; form-action 'self'; script-src 'self' 'unsafe-inline' https://challenges.cloudflare.com https://www.googletagmanager.com https://connect.facebook.net https://static.cloudflareinsights.com https://*.paypal.com https://*.paypalobjects.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https:; media-src 'self' blob: https:; connect-src 'self' https://*.boutq.store https://boutq.store wss://*.boutq.store https://*.cloudflare.com https://*.cloudflareinsights.com https://challenges.cloudflare.com https://*.supabase.co wss://*.supabase.co https://*.googleapis.com https://*.r2.cloudflarestorage.com https://media.boutq.store https://www.google-analytics.com https://region1.google-analytics.com https://*.google-analytics.com https://www.googletagmanager.com https://connect.facebook.net https://*.facebook.com https://static.cloudflareinsights.com https://cloudflareinsights.com https://*.paypal.com; frame-src 'self' https://*.boutq.store https://challenges.cloudflare.com https://*.paypal.com; worker-src 'self' blob:; upgrade-insecure-requests",
