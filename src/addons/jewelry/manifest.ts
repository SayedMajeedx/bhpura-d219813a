  ...
  contributions: {
    vocabulary: {
      ...
      workshop_notes_label: {
        ar: "ملاحظات وتفاصيل الصياغة والحفر:",
        en: "Crafting & Engraving Notes:",
      },
    ...
    customFieldPresets: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label_en: "Font Style",
            type: "select",
            options: ["رقعة", "نسخ", "English Cursive", "English Block"],
            required: false,
          },
          {
            key: "material_swatch",
            ...
            label_en: "Metal",
            type: "select",
            options: ["ذهب أصفر", "ذهب أبيض", "فضة 925"],
            required: false,
          },
        ],
      },
