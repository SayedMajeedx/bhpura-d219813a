...
export function OsSidebar({
  ...
  // Re-sync when activeSlug changes
  React.useEffect(() => {
          ...
          {!collapsed ? (
            <div className="space-y-2">
              <button
                ...
                className={cn(
                  "w-full flex items-center justify-between px-3 py-2 text-xs font-semibold rounded-xl border transition-all duration-200 shadow-2xs",
                  appsDrawerOpen
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span>{isAr ? "كافة الأدوات والتطبيقات" : "All Apps & Tools"}</span>
                </div>
            ...
            <div className="flex justify-center">
              <button
                type="button"
                onClick={onToggleCollapse}
                title={isAr ? "كافة الأدوات والتطبيقات" : "All Apps & Tools"}
                className="h-9 w-9 rounded-xl bg-muted/40 hover:bg-muted text-muted-foreground hover:text-foreground flex items-center justify-center transition-all shadow-2xs border border-border/40"
              >
