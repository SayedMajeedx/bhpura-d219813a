  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom: Apps & Tools Hub Modal Trigger, Storefront Link & Super Admin Switcher */}
        <div className="flex flex-col items-center gap-2.5 w-full">
          {/* Apps & Tools Hub Trigger Button (Exact user requested spot) */}
