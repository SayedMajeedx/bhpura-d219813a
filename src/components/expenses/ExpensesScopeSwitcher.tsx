import { TrendingUp, PackageCheck, Wallet, Receipt, DollarSign } from "lucide-react";
...
export function ExpensesScopeSwitcher({
  ...
  return (
    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5 p-1.5 bg-muted/30 border border-border/60 rounded-2xl">
      {/* 1. Total Revenue */}
      ...
      {/* 5. Net Profit & Margin */}
      <div className="col-span-2 sm:col-span-4 lg:col-span-1 flex flex-col gap-0.5 p-3 rounded-xl bg-card border border-border/50 shadow-2xs">
        <div className="flex items-center justify-between text-[11px] font-semibold text-muted-foreground">
