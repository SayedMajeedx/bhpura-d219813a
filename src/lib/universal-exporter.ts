...
export function exportToCsv(
  ...
  const dataLines = rows.map((row) =>
    columns.map((col) => sanitizeForCsv(row[col.key])).join(","),
  );
...
export const PRODUCT_PRESETS: ExportPreset[] = [
  {
    ...
    descriptionEn: "Complete product catalog with all variants, barcodes, SKUs, inventory, and bilingual text",
    descriptionAr: "الكتالوج الكامل متضمناً كافة المقاسات والألوان والباركود والمخزون والوصف بالعربية والإنجليزية",
    columns: [
      ...
      { key: "selling_price", headerEn: "Price", headerAr: "سعر البيع", format: "currency", width: 14 },
      { key: "cost_price", headerEn: "Cost", headerAr: "سعر التكلفة", format: "currency", width: 14 },
      { key: "stock_main", headerEn: "Stock (Main)", headerAr: "المخزون الرئيسي", format: "number", width: 14 },
      { key: "stock_incubator", headerEn: "Stock (Consignment)", headerAr: "مخزون العُهد", format: "number", width: 16 },
      { key: "total_stock", headerEn: "Total Stock", headerAr: "إجمالي المخزون", format: "number", width: 14 },
      ...
      { key: "description_en", headerEn: "Description (EN)", headerAr: "الوصف (إنجليزي)", width: 35 },
    ],
  },
  {
    ...
    columns: [
      ...
      { key: "variant_inventory_tracker", headerEn: "Variant Inventory Tracker", headerAr: "Variant Inventory Tracker", width: 22 },
      { key: "variant_inventory_qty", headerEn: "Variant Inventory Qty", headerAr: "Variant Inventory Qty", format: "number", width: 20 },
      { key: "variant_price", headerEn: "Variant Price", headerAr: "Variant Price", format: "currency", width: 14 },
      { key: "variant_compare_at_price", headerEn: "Variant Compare At Price", headerAr: "Variant Compare At Price", width: 22 },
      { key: "variant_barcode", headerEn: "Variant Barcode", headerAr: "Variant Barcode", width: 18 },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "selling_price", headerEn: "Selling Price", headerAr: "سعر البيع", format: "currency", width: 14 },
      { key: "cost_price", headerEn: "Cost Price", headerAr: "سعر التكلفة", format: "currency", width: 14 },
      { key: "sku", headerEn: "SKU", headerAr: "رمز المنتج (SKU)", width: 18 },
      { key: "barcode", headerEn: "Barcode", headerAr: "الباركود", width: 18 },
      { key: "total_stock", headerEn: "Quantity", headerAr: "الكمية المتاحة", format: "number", width: 14 },
      { key: "size", headerEn: "Size", headerAr: "المقاس", width: 12 },
      { key: "color", headerEn: "Color", headerAr: "اللون", width: 12 },
  ...
  },
  {
    ...
    descriptionEn: "Stock audit sheet with unit cost, retail price, and total monetary inventory valuation",
    descriptionAr: "كشف جرد مالي يوضح كميات المخزون وتكلفة الوحدة والقيمة المالية الإجمالية للبضاعة",
    columns: [
      ...
      { key: "total_stock", headerEn: "Total On Hand", headerAr: "إجمالي الكمية", format: "number", width: 14 },
      { key: "cost_price", headerEn: "Unit Cost", headerAr: "تكلفة الوحدة", format: "currency", width: 14 },
      { key: "total_cost_value", headerEn: "Holding Asset Value", headerAr: "إجمالي قيمة التكلفة", format: "currency", width: 18 },
      { key: "selling_price", headerEn: "Retail Price", headerAr: "سعر البيع للوحدة", format: "currency", width: 16 },
      { key: "total_retail_value", headerEn: "Potential Revenue", headerAr: "إجمالي القيمة البيعية", format: "currency", width: 18 },
...
export const CUSTOMER_PRESETS: ExportPreset[] = [
  {
    ...
    descriptionEn: "Complete profiles with verified GCC phone numbers, emails, order counts, and lifetime spend",
    descriptionAr: "قاعدة البيانات الشاملة مع أرقام الهواتف المعيارية، البريد، عدد الطلبات، وإجمالي الإنفاق",
    columns: [
      ...
      { key: "total_orders", headerEn: "Total Orders", headerAr: "عدد الطلبات", format: "number", width: 14 },
      { key: "total_spent", headerEn: "Lifetime Spend", headerAr: "إجمالي المشتريات", format: "currency", width: 16 },
  ...
  },
  {
    ...
    descriptionEn: "Sanitized clean phone numbers formatted with international GCC prefix for bulk campaigns",
    ...
    columns: [
      ...
      { key: "clean_phone", headerEn: "WhatsApp Number", headerAr: "رقم الواتساب المنقح", width: 20 },
      { key: "total_orders", headerEn: "Orders Count", headerAr: "عدد الطلبات", format: "number", width: 14 },
      { key: "total_spent", headerEn: "Total Spend", headerAr: "المشتريات", format: "currency", width: 16 },
  ...
  },
  {
    ...
    descriptionEn: "High-value loyal patrons filtered by purchase volume for loyalty rewards & private drops",
    ...
    columns: [
      ...
      { key: "total_spent", headerEn: "Total Spend", headerAr: "إجمالي الإنفاق", format: "currency", width: 16 },
      { key: "total_orders", headerEn: "Orders", headerAr: "عدد الطلبات", format: "number", width: 12 },
      { key: "average_order_value", headerEn: "Avg Order Value", headerAr: "متوسط قيمة الطلب", format: "currency", width: 16 },
...
export const ORDER_PRESETS: ExportPreset[] = [
  {
    ...
    descriptionEn: "One row per order with invoice number, customer info, delivery state, payment, and totals",
    descriptionAr: "سطر لكل طلب يوضح رقم الفاتورة والعميل وطريقة الدفع وحالة التوصيل والمبلغ الإجمالي",
    columns: [
      ...
      { key: "items_count", headerEn: "Items Qty", headerAr: "عدد القطع", format: "number", width: 12 },
      { key: "subtotal", headerEn: "Subtotal", headerAr: "المجموع الفرعي", format: "currency", width: 14 },
      { key: "discount_amount", headerEn: "Discount", headerAr: "الخصم", format: "currency", width: 14 },
      { key: "delivery_fee", headerEn: "Shipping", headerAr: "رسوم الشحن", format: "currency", width: 14 },
      { key: "tax_amount", headerEn: "VAT Amount", headerAr: "الضريبة", format: "currency", width: 14 },
      { key: "total", headerEn: "Grand Total", headerAr: "الإجمالي النهائي", format: "currency", width: 16 },
  ...
  },
  {
    ...
    descriptionEn: "Detailed audit row per individual item sold: SKU, product name, quantity, unit price, total",
    ...
    columns: [
      ...
      { key: "unit_price", headerEn: "Unit Price", headerAr: "سعر الوحدة", format: "currency", width: 14 },
      { key: "item_total", headerEn: "Line Total", headerAr: "إجمالي السطر", format: "currency", width: 14 },
  ...
  },
  {
    ...
    descriptionEn: "Clean revenue journal for accounting software (QuickBooks, Xero, Zoho Books, VAT returns)",
    descriptionAr: "كشف محاسبي معتمد لإقرارات القيمة المضافة ومطابقة الدفاتر المحاسبية بدقة",
    columns: [
      { key: "invoice_number", headerEn: "Tax Invoice #", headerAr: "رقم الفاتورة الضريبية", width: 16 },
      ...
      { key: "gross_sales", headerEn: "Gross Sales", headerAr: "إجمالي المبيعات", format: "currency", width: 14 },
      { key: "discounts", headerEn: "Discounts Allowed", headerAr: "الخصومات", format: "currency", width: 14 },
      { key: "net_merchandise", headerEn: "Net Merchandise", headerAr: "صافي البضاعة", format: "currency", width: 14 },
      { key: "shipping_collected", headerEn: "Shipping Revenue", headerAr: "إيرادات الشحن", format: "currency", width: 14 },
      { key: "taxable_amount", headerEn: "Taxable Base", headerAr: "المبلغ الخاضع للضريبة", format: "currency", width: 16 },
      { key: "vat_collected", headerEn: "VAT Collected", headerAr: "ضريبة القيمة المضافة", format: "currency", width: 16 },
      { key: "total_collected", headerEn: "Total Amount Due", headerAr: "المبلغ المستلم الإجمالي", format: "currency", width: 18 },
...
export const EXPENSE_PRESETS: ExportPreset[] = [
  {
    ...
    descriptionEn: "Operational overhead journal: rent, marketing, packaging, courier fees, and utilities",
