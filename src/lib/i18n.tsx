...
const en: Dict = {
  ...
  "expenses.categoryPh": "e.g. Packaging, Inventory, Shipping",
  ...
  "orderDetail.lineItems": "Order Items",
  "orderDetail.addLine": "Add Product / Service",
...
const ar: Dict = {
  ...
  "app.portalSubtitle": "لوحة إدارة البوتيك",
  ...
  "activity.inventoryTitle": "سجل حركة المخزون",
  ...
  "expenses.categoryPh": "مثال: بضائع، تغليف، شحن",
  ...
  "log.stock.manual": "تم تعديل المخزون يدوياً من {from} إلى {to} للخيار {variant}",
  "log.product.created": "تم إنشاء المنتج '{name}'",
  "log.product.updated": "تم تحديث المنتج '{name}'",
  "log.product.deleted": "تم حذف المنتج '{name}'",
  "log.variant.created": "تمت إضافة الخيار '{variant}'",
  "log.variant.deleted": "تم حذف الخيار '{variant}'",

  "customers.title": "العملاء",
  "customers.subtitle": "قائمة العملاء وبيانات التواصل والطلبات.",
  ...
  "integrations.title": "التكامل والربط التقني",
  "integrations.subtitle":
    "احفظ مفاتيح API ورموز الويبهوك لشركات الشحن وبوابات الدفع والخدمات المخصصة.",
  "integrations.new": "إضافة ربط جديد",
  "integrations.none": "لا يوجد ربط حالياً. أضف بيانات الخدمة للتحضير لبوابة شحن أو دفع.",
  "integrations.provider": "الخدمة",
  "integrations.baseUrl": "رابط الخدمة الأساسي (Base URL)",
  "integrations.apiKey": "مفتاح API",
  "integrations.webhookSecret": "رمز أمان الويبهوك (Webhook Secret)",
  ...
  "brands.deleteHardOption": "حذف جميع بيانات وصور العلامة نهائياً",
  ...
  "orderDetail.lineItems": "محتويات الطلب",
  "orderDetail.addLine": "إضافة منتج / خدمة",
