...
const en: Dict = {
  ...
  "brands.deleteHardOption": "Permanently delete (only allowed if no orders and no products exist)",
...
const ar: Dict = {
  ...
  "brands.deleteHardOption": "حذف نهائي (مسموح فقط عند عدم وجود أي طلبات أو منتجات)",
