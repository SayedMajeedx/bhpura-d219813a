...
const ar: Dict = {
  ...
  "auth.forgotSubtitle": "أدخلي بريدك الإلكتروني وسنرسل لك رابط استعادة آمن.",
  "auth.sendResetLink": "إرسال رابط الاستعادة",
  "auth.resetLinkSent": "تم إرسال بريد الاستعادة. تحققي من صندوق الوارد.",
  "auth.backToSignIn": "← العودة لتسجيل الدخول",
  "auth.resetTitle": "تعيين كلمة مرور جديدة",
  "auth.resetSubtitle": "اختاري كلمة مرور قوية لم تستخدميها من قبل.",
  ...
  "expenses.subtitle": "تتبّعي التكاليف التشغيلية لحساب صافي الربح.",
