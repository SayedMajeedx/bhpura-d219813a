...
| Admin catalog: products, variants, stock, packaging BOM and materials, paid add-ons (customization options); reads (inventory, orders, expenses, dashboard) and writes (inventory, BOM editor, packaging tab, add-ons tab)                                                                               | `catalog/`                 | orders, dashboard, accounting and expenses screens; inventory, `components/inventory`, `components/products`                                                                           |
...
| Brand row: settings profile, super admin list and edit; lookups (admin route guard and icons, admin home redirect, brand switcher and super overrides directory, command palette, onboarding slug check, storefront host resolution)                                                                     | `brands/`                  | settings feature and cards, Pages                                                                                                                                                      |
...
| Message templates: every template (send-invoice dialog) and one channel's (Campaigns, WhatsApp); writes carry the brand being edited                                                                                                                                                                     | `message-templates/`       | Campaigns page (customers block); order components (orders block)                                                                                                                      |
| Profiles: the caller's profile every route guard checks, the brand's couriers, names next to stock movements, profile updates                                                                                                                                                                            | `profiles/`                | every route, component and feature (server routes and first-login excepted)                                                                                                            |
| Returns: admin list, detail and exchange picker, the dashboard's pending count, the order editor's linked returns, the shopper's returns, the return policy (editor, readiness checklist, return request)                                                                                                | `returns/`                 | returns routes and `components/returns/**`; orders, dashboard, accounting and expenses screens; storefront routes and slices; settings cards                                           |
| Push notifications: customer devices and marketing campaigns (push centre), device registration from the native app shells                                                                                                                                                                               | `push/`                    | push centre (customers block)                                                                                                                                                          |
| Admin alert recipients: the recipients editor (settings, Communications) and the Communications count                                                                                                                                                                                                    | `notification-recipients/` | settings screens, Communications page                                                                                                                                                  |
| Super admin video re-optimizer: every hero and product video, and swapping one for its optimized copy                                                                                                                                                                                                    | `media-optimizer/`         | none yet (super admin screens still read brands directly elsewhere)                                                                                                                    |
| Reporting: the overview, sales, products and customers reports (Reports pages; the dashboard shares the overview), incubator sales, catalog inquiries                                                                                                                                                    | `reporting/`               | orders, dashboard, accounting and expenses screens; `reports-*` keys everywhere                                                                                                        |
| Accounting tabs: cash accounts and the transfer log, vendors, purchase orders                                                                                                                                                                                                                            | `accounting/`              | orders, dashboard, accounting and expenses screens                                                                                                                                     |
