...
| Business settings row: reads (settings form, order editor, dashboard, reports, Pages, readiness checklist, packaging tab) and writes (settings form, Pages, store profile card, BOM switch)                                                                                        | `business-settings/` | orders, dashboard, accounting and expenses screens; settings feature and cards, Pages                                                                                                  |
...
| Narrow `business_settings` reads in other admin screens (currency, business name, favicon, typography), smaller domains                                                                                                                                                            | not yet              | —                                                                                                                                                                                      |
