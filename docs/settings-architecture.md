...
4. **معاينة المتجر**:
   - زر "معاينة المتجر" في رأس الإعدادات يفتح المتجر في تبويب جديد.
   - أُزيلت اللوحة الجانبية (`LivePreviewPane`) في `5f3e0de9` لإعطاء الإعدادات عرضاً كاملاً، ثم حُذف ملفها في 2026-09-24 لأنه لم يعد مستخدماً. كانت تعيد تحميل المتجر بعد الحفظ فقط، أي نفس ما يفعله الزر.
   - معاينات مركّزة في أماكنها: معاينة شريحة الهيرو على الجوال والكمبيوتر مع نسبة القص (`HeroFramePreview`)، ومعاينة شعار الفاتورة وموضعه.
