ALTER TABLE public.business_settings
  ADD COLUMN IF NOT EXISTS storefront_typography jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS admin_typography jsonb NOT NULL DEFAULT '{}'::jsonb;

ALTER TABLE public.business_settings
  DROP CONSTRAINT IF EXISTS business_settings_storefront_typography_object,
  ADD CONSTRAINT business_settings_storefront_typography_object
    CHECK (jsonb_typeof(storefront_typography) = 'object'),
  DROP CONSTRAINT IF EXISTS business_settings_admin_typography_object,
  ADD CONSTRAINT business_settings_admin_typography_object
    CHECK (jsonb_typeof(admin_typography) = 'object');

CREATE OR REPLACE VIEW public.brand_public_settings WITH (security_invoker = true) AS
SELECT bs.brand_id, bs.business_name, bs.logo_url, bs.currency, bs.primary_color, bs.text_color, bs.background_color, bs.font_family, bs.font_url,
 ...
 bs.global_sale_badges_enabled, bs.cart_drawer_checkout_bg, bs.cart_drawer_checkout_fg, bs.vat_inclusive, bs.shipping_zones,
 bs.storefront_loader_text_en, bs.storefront_loader_text_ar, bs.storefront_radius, bs.header_glass, bs.badge_accent,
