-- Migration: Add hero_video_fit to business_settings and brand_public_settings
-- Enables merchants to control video presentation (smart ambient cinema glow vs full crop)

ALTER TABLE public.business_settings
  ADD COLUMN IF NOT EXISTS hero_video_fit text DEFAULT 'contain_ambient';

-- Recreate brand_public_settings view with hero_video_fit
