-- Custom-tailored lines are made to order and must never consume ready stock.
ALTER TABLE public.order_items
  DROP CONSTRAINT IF EXISTS order_items_location_check;

ALTER TABLE public.order_items
  ADD CONSTRAINT order_items_location_check
  CHECK (location IN ('main', 'incubator', 'custom'));
  ...
  IF v_deducting THEN
    ...
    FOR r IN
      ...
      WHERE order_id = p_order_id
        ...
        AND COALESCE(location, 'main') IN ('main', 'incubator')
