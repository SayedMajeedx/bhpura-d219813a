-- Migration: 20260905140000_three_day_trial_and_lockout.sql
-- Description:
-- 1. Updates SaaS trial plan duration to 3 days.
-- 2. Updates get_storefront_page_data to gracefully return suspension info when trial is expired.
-- 3. Guards place_storefront_order_internal_20260710 against expired trials.

UPDATE public.saas_plans
SET
  trial_days = 3,
  description_ar = '3 أيام لتجربة منصة Boutq OS بالكامل',
  description_en = '3 days to experience the full power of Boutq OS',
  updated_at = now()
WHERE code = 'trial';

-- Update get_storefront_page_data to check trial expiration
