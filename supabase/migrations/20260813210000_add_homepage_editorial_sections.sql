ALTER TABLE public.business_settings
  ADD COLUMN IF NOT EXISTS homepage_editorial_sections jsonb NOT NULL DEFAULT
  '{
    "best": {"enabled": true, "banner_image_url": "", "background_color": "", "background_image_url": ""},
    "sale": {"enabled": true, "banner_image_url": "", "background_color": "", "background_image_url": ""},
    "trending": {"enabled": true, "banner_image_url": "", "background_color": "", "background_image_url": ""}
  }'::jsonb;

UPDATE public.business_settings
SET homepage_editorial_sections = jsonb_set(
  homepage_editorial_sections,
  '{trending,banner_image_url}',
  to_jsonb(trending_banner_background_url),
  true
)
WHERE trending_banner_background_url IS NOT NULL
  AND trending_banner_background_url <> ''
  AND COALESCE(homepage_editorial_sections #>> '{trending,banner_image_url}', '') = '';
...
SELECT bs.brand_id, bs.business_name, bs.logo_url, bs.currency, bs.primary_color, bs.text_color, bs.background_color, bs.font_family, bs.font_url,
 ...
 bs.secondary_banner_parallax_enabled, bs.secondary_banner_parallax_mobile_enabled,
 bs.secondary_banner_parallax_breakpoint,
 bs.trending_banner_background_url, bs.category_banner_background_url,
