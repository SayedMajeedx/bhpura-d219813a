ALTER TABLE public.business_settings
  ADD COLUMN IF NOT EXISTS cart_drawer_checkout_bg text,
  ADD COLUMN IF NOT EXISTS cart_drawer_checkout_fg text;

GRANT SELECT (cart_drawer_checkout_bg, cart_drawer_checkout_fg)
