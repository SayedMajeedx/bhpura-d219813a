...
-- 2) Backfill: Every brand existing today was created when the platform was fashion-only
...
-- 3) Fit Passport data protection: Any brand with customer_fit_passports rows retains modules
UPDATE public.business_settings bs
...
-- 4) Redefine brand_public_settings view (append-only)
