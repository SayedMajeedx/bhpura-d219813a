-- Migration: Add custom trust_badges to business_settings
ALTER TABLE public.business_settings 
ADD COLUMN IF NOT EXISTS trust_badges jsonb DEFAULT '{"enabled": true, "items": []}'::jsonb;

-- Expose in brand_public_settings view
