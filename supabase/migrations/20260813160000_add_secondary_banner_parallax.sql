ALTER TABLE public.business_settings
  ADD COLUMN IF NOT EXISTS secondary_banner_parallax_enabled boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS secondary_banner_parallax_mobile_enabled boolean NOT NULL DEFAULT true,
  ADD COLUMN IF NOT EXISTS secondary_banner_parallax_breakpoint integer NOT NULL DEFAULT 768
    CHECK (secondary_banner_parallax_breakpoint BETWEEN 320 AND 1920);
