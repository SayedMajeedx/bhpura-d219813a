...
async function main() {
  ...
  if (unexpectedChanges.length > 0) {
    ...
    console.log(
      "SUCCESS: Only business_name and updated_at were touched! Zero unrelated fields dirtied.",
    );
  }
  ...
  await saveBtn.click();
  await page.waitForSelector("text=تم حفظ الإعدادات بنجاح, text=Settings saved", {
    timeout: 10000,
  });
